...
listaPlatos.append(Plato("Huevos revueltos"    ,Ordinal.SEGUNDO,Tipo.HUEVO,9   ,750))
listaPlatos.append(Plato("Fabada asturiana"    ,Ordinal.SEGUNDO,Tipo.LEGUMBRE,9   ,750))

listaPlatos.append(Plato("Tortilla de patata"    ,Ordinal.SEGUNDO,Tipo.HUEVO,9   ,750))
listaPlatos.append(Plato("Potaje de vigilia"    ,Ordinal.SEGUNDO,Tipo.LEGUMBRE,9   ,750))

listaPlatos.append(Plato("Verduras a la brasa"             ,Ordinal.PRIMERO,Tipo.VERDURA,5   ,250))
listaPlatos.append(Plato("Pure de calabaza"             ,Ordinal.PRIMERO,Tipo.VERDURA,5   ,250))
random.shuffle(listaPlatos)
...
def goal():
    f.write("  (:goal\n")
    f.write("    (forall (?dia - dia) (tiene_menu ?dia))\n" if num_ext < 3 else "    (forall (?dia - dia) (and (tiene_primero ?dia) (tiene_segundo ?dia)))\n")
